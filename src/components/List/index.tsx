...
const List: React.FC<Props> = props => {
  ...
  return (
    <Draggable draggableId={`listId-${listId}`} index={listIndex} isDragDisabled={isDragDisabled}>
      {provided => (
        <StyledPaper
        ...
        >
          ...
          <Droppable droppableId={`listId-${listId}`} type="Card">
            {cardProvided => (
              <StyledContainer {...cardProvided.droppableProps} ref={cardProvided.innerRef}>
                {renderCards()}
